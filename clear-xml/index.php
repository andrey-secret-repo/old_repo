...
<head>
	...
	<style>
	table, tr, td, th{ border-collapse: collapse; border: 1px solid; padding: 5px; } table{ float: left; } form { width: 400px; height: 150px; border-radius: 25px; box-sizing: border-box; padding: 20px 25px; float: left; margin: 50px; box-shadow: 0 0 25px -2px #000; } form h3{ margin: 0; } form input[type=text]{ width: 350px; height: 40px; outline: none; box-sizing: border-box; padding: 10px; margin: 10px 0; } .msg a { margin: 5px; }
</style>
</head>
<body>
			...
			$('.form1').submit(function(){
				...
				$.ajax({
					...
					success: function( result ){
						if(result.status == 'ok'){
							$('.msg1').html('<a href="'+result.msg+'">Посмотреть</a>');
